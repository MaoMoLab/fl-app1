...
part 'old_service_shop_input.g.dart';

@JsonSerializable()
class OldServiceShopInput {
  const OldServiceShopInput({
    required this.id,
  ...
  factory OldServiceShopInput.fromJson(Map<String, Object?> json) =>
      _$OldServiceShopInputFromJson(json);
  ...
  Map<String, Object?> toJson() => _$OldServiceShopInputToJson(this);
}
