...
class UserNavigationRailComponent extends StatefulWidget {
  const UserNavigationRailComponent({super.key});

  @override
  State<UserNavigationRailComponent> createState() =>
      _UserNavigationRailComponentState();
}

class _UserNavigationRailComponentState
    extends State<UserNavigationRailComponent> {
